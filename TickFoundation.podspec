Pod::Spec.new do |s|
  ...
  s.version      = "1.0.0"
  s.summary      = "dida-logistics-mobile TickFoundation for ios."
  s.description  = "dida-logistics-mobile TickFoundation"
  ...
  s.source_files  = "TickFoundation-IOS/Classes/**/*"
  s.resources = "TickFoundation-IOS/Assets/*"
  s.requires_arc = true
